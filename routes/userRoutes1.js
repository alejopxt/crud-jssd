...
//Middleware de diagnostico para todas las rutas
...
//GET /api/users - Listar usuarios (admin, coordinador pueden ver todos, auxiliares solo se ve a si mismo)
router.get('/',
    verifyToken,
...
// POST /api/user / crear usuario solo (admin)
router.post('/',
    verifyToken,
    checkRole('admin'),
...
// DELETE /api/users/:id - Eliminar usuarios (solo admin)
router.delete('/id',
    verifyToken,
    checkRole('admin'),
